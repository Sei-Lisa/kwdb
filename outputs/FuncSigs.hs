...
funcDescriptions = [
    ...
    ("llHMAC",(["private_key","msg","algorithm"],"Returns a string that is the Base64-encoded HMAC hash of msg when using hash algorithm algorithm and secret key private_key. This function supports md5, sha1, sha224, sha256, sha384, sha512 for algorithm.\n")),
    ...
    ("llReplaceSubString",(["src","pattern","replacement_pattern","count"],"Returns a string that is the result of replacing the first count matching instances pattern in src with replacement_pattern.\n")),
    ...
    ("llSignRSA",(["private_key","msg","algorithm"],"Returns a string that is the Base64-encoded RSA signature of msg when using hash algorithm algorithm and secret key private_key. Can be paired with llVerifyRSA to pass verifiable messages. This function supports md5, sha1, sha224, sha256, sha384, sha512 for algorithm.\n")),
    ...
    ("llVerifyRSA",(["public_key","msg","signature","algorithm"],"Returns an integer indicating whether the RSA signature is valid for msg when using hash algorithm algorithm and public RSA key public_key. Returns TRUE if the signature is verified, and FALSE otherwise. Can be paired with llSignRSA to validate the authenticity of messages from other LSL scripts. This function supports md5, sha1, sha224, sha256, sha384, sha512 for algorithm.\n")),
