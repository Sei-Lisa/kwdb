...
funcDescriptions = [
    ...
    ("llHMAC",(["authkey","message","hashalg"],"(No Description)\n")),
    ...
    ("llReplaceSubString",(["source","search","replace","count"],"(No Description)\n")),
    ...
    ("llSignRSA",(["privkey","message","hashalg"],"(No Description)\n")),
    ...
    ("llVerifyRSA",(["pubkey","message","signature","hashalg"],"(No Description)\n")),
