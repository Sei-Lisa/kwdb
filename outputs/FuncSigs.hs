...
funcDescriptions = [
    ...
    ("llLinksetDataDelete",(["key"],"(No Description)\n")),
    ("llLinksetDataDeleteProtected",(["key","password"],"(No Description)\n")),
    ("llLinksetDataFindKeys",(["pattern","start","count"],"(No Description)\n")),
    ("llLinksetDataListKeys",(["start","count"],"(No Description)\n")),
    ("llLinksetDataRead",(["key"],"(No Description)\n")),
    ("llLinksetDataReadProtected",(["key","password"],"(No Description)\n")),
    ("llLinksetDataReset",([],"(No Description)\n")),
    ("llLinksetDataWrite",(["key","value"],"(No Description)\n")),
    ("llLinksetDataWriteProtected",(["key","value","password"],"(No Description)\n")),
