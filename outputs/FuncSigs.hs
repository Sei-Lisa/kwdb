...
functionSigs = [
    ...
    ("llClearExperiencePermissions",LLVoid,[("agent",LLKey)],
        "(No Description)"),
    ...
    ("llCloud",LLFloat,[("offset",LLVector)],
    ...
    ("llGetAttachedList",LLList,[("agent",LLKey)],
        "(No Description)"),
    ...
    ("llGetExperienceErrorMessage",LLString,[("value",LLInteger)],
        "(No Description)"),
    ("llGetExperienceList",LLList,[("agent",LLKey)],
        "(No Description)"),
    ("llGetForce",LLVector,[],
    ...
    ("llGetObjectLinkKey",LLKey,[("id",LLKey),("link",LLInteger)],
        "(No Description)"),
    ...
    ("llGetVisualParams",LLList,[("id",LLKey),("params",LLList)],
        "(No Description)"),
    ...
    ("llLinksetDataCountKeys",LLInteger,[],
        "(No Description)"),
    ("llLinksetDataDelete",LLInteger,[("keyname",LLString)],
        "(No Description)"),
    ...
    ("llLinksetDataDeleteProtected",LLInteger,[("keyname",LLString),("password",LLString)],
        "(No Description)"),
    ...
    ("llLinksetDataListKeys",LLList,[("start",LLInteger),("count",LLInteger)],
        "(No Description)"),
    ("llLinksetDataRead",LLString,[("keyname",LLString)],
        "(No Description)"),
    ("llLinksetDataReadProtected",LLString,[("keyname",LLString),("password",LLString)],
        "(No Description)"),
    ("llLinksetDataReset",LLVoid,[],
        "(No Description)"),
    ("llLinksetDataWrite",LLInteger,[("keyname",LLString),("value",LLString)],
        "(No Description)"),
    ("llLinksetDataWriteProtected",LLInteger,[("keyname",LLString),("value",LLString),("password",LLString)],
        "(No Description)"),
    ...
    ("llRemoteLoadScript",LLVoid,[("target",LLKey),("name",LLString),("running",LLInteger),("start_param",LLInteger)],
    ...
    ("llReplaceEnvironment",LLInteger,[("position",LLVector),("environment",LLString),("track_no",LLInteger),("day_length",LLInteger),("day_offset",LLInteger)],
        "(No Description)"),
    ("llReplaceSubString",LLString,[("source",LLString),("search",LLString),("replace",LLString),("count",LLInteger)],
    ...
    ("llRequestUserKey",LLKey,[("name",LLString)],
        "(No Description)"),
    ...
    ("llSignRSA",LLString,[("privkey",LLString),("message",LLString),("hashalg",LLString)],
    ...
    ("llTargetedEmail",LLVoid,[("target",LLInteger),("header",LLString),("body",LLString)],
        "(No Description)"),
    ...
    ("llVerifyRSA",LLInteger,[("pubkey",LLString),("message",LLString),("signature",LLString),("hashalg",LLString)],
