...
-- Generated by LSL2 Derived Files Generator. Database version: 0.0.20240528000; output module version: 0.0.20231219001
functionSigs = [
    ...
    ("llAdjustDamage",LLVoid,[("number",LLInteger),("new_damage",LLFloat)],
        "Modifies the amount of damage that will be applied by the current on_damage event after it has completed processing."),
    ...
    ("llDamage",LLVoid,[("target",LLKey),("damage",LLFloat),("damage_type",LLInteger)],
        "Delivers damage to tasks and agent in the same region."),
    ...
    ("llDerezObject",LLInteger,[("id",LLKey),("flag",LLInteger)],
        "Derezzes an object previously rezzed from within the object containing the script. Returns success or failure."),
    ...
    ("llDetectedType",LLInteger,[("number",LLInteger)],
        "Returns the type (AGENT, ACTIVE, PASSIVE, DAMAGEABLE and/or SCRIPTED) of detected object (returns 0 if number is not a valid sensed object)"),
    ...
    ("llSensor",LLVoid,[("name",LLString),("id",LLKey),("type",LLInteger),("range",LLFloat),("arc",LLFloat)],
        "Performs a single scan for name and id with type (AGENT, ACTIVE, PASSIVE, DAMAGEABLE and/or SCRIPTED) within range meters and arc radians of forward vector (name, id, and/or keytype can be empty or 0)"),
    ...
    ("llSensorRepeat",LLVoid,[("name",LLString),("id",LLKey),("type",LLInteger),("range",LLFloat),("arc",LLFloat),("rate",LLFloat)],
        "Sets a callback for name and id with type (AGENT, ACTIVE, PASSIVE, DAMAGEABLE and/or SCRIPTED) within range meters and arc radians of forward vector (name, id, and/or keytype can be empty or 0) and repeats every rate seconds"),
