...
-- Generated by LSL2 Derived Files Generator. Database version: 0.0.20130526001; output module version: 0.0.20130101000
funcSigs = [
...
funcDescriptions = [
    ...
    ("llDetectedTouchBinormal",(["index"],"Returns the surface binormal for a triggered touch event\n")),
    ("llDetectedTouchFace",(["index"],"Returns the index of the face where the avatar clicked in a triggered touch event\n")),
    ("llDetectedTouchNormal",(["index"],"Returns the surface normal for a triggered touch event\n")),
    ("llDetectedTouchPos",(["index"],"Returns the position where the object was touched in a triggered touch event\n")),
    ("llDetectedTouchST",(["index"],"Returns the s and t coordinates in the first two components of a vector, for the surface coordinates where the prim was touched in a triggered touch event\n")),
    ("llDetectedTouchUV",(["index"],"Returns the u and v coordinates in the first two components of a vector, for the texture coordinates where the prim was touched in a triggered touch event\n")),
    ...
    ("llMakeExplosion",(["particles","scale","vel","lifetime","arc","texture","offset"],"Makes a round explosion of particles\n")),
    ("llMakeFire",(["particles","scale","vel","lifetime","arc","texture","offset"],"Makes fire like particles\n")),
    ("llMakeFountain",(["particles","scale","vel","lifetime","arc","bounce","texture","offset","bounce_offset"],"Makes a fountain of particles\n")),
    ("llMakeSmoke",(["particles","scale","vel","lifetime","arc","texture","offset"],"Makes smoke like particles\n")),
    ...
    ("llParseStringKeepNulls",(["src","separators","spacers"],"Breaks src into a list, discarding separators, keeping spacers, keeping any null values generated.\n(separators and spacers must be lists of strings, maximum of 8 each)\n")),
    ...
    ("llSetObjectDesc",(["name"],"Sets the prim's description\n")),
    ...
    ("llXorBase64Strings",(["s1","s2"],"DEPRECATED!  Please use llXorBase64StringsCorrect instead.\nIncorrectly performs an exclusive or on two Base64 strings and returns a Base64 string.  s2 repeats if it is shorter than s1.  Retained for backwards compatability.\n")),
    ("llXorBase64StringsCorrect",(["s1","s2"],"Correctly performs an exclusive or on two Base64 strings and returns a Base64 string.\ns2 repeats if it is shorter than s1.\n"))
    ]
