...
-- Generated by LSL2 Derived Files Generator. Database version: 0.0.20210519000; output module version: 0.0.20130817000
funcSigs = [
    ...
    ("llOpenFloater",LLInteger,[LLString,LLString,LLList]),
...
funcDescriptions = [
    ...
    ("llOpenFloater",(["title","url","params"],"(No Description)\n")),
