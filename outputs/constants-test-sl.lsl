...
default
{
    state_entry()
    {
        ...
        line = 107;
outp += "\nGenerated by LSL2 Derived Files Generator. Database version: 0.0.20250202000; output module version: 0.0.20140625000";
c([
1,TRUE
,0,FALSE
,0x1,STATUS_PHYSICS
...
,4,PRIM_REFLECTION_PROBE_MIRROR
,0x1,DENSITY
,0x2,FRICTION
,0x4,RESTITUTION
...
,2,REZ_FLAG_PHYSICAL
,4,REZ_FLAG_PHANTOM
,8,REZ_FLAG_DIE_ON_COLLIDE
,16,REZ_FLAG_DIE_ON_NOENTRY
,32,REZ_FLAG_NO_COLLIDE_OWNER
,64,REZ_FLAG_NO_COLLIDE_FAMILY
,128,REZ_FLAG_BLOCK_GRAB_OBJECT
,2,REZ_POS
,3,REZ_ROT
]);
c([
...
,11,REZ_LOCK_AXES
,50,PRIM_SIT_FLAGS
,1,SIT_FLAG_SIT_TARGET
,2,SIT_FLAG_ALLOW_UNSIT
,4,SIT_FLAG_SCRIPTED_ONLY
,16,SIT_FLAG_NO_COLLIDE
,32768,AGENT_FLOATING_VIA_SCRIPTED_ATTACHMENT
,-1,ATTACH_ANY_HUD
,1,BEACON_MAP
,2147483646,COMBAT_CHANNEL
,0x20,DAMAGEABLE
,-1,DAMAGE_TYPE_IMPACT
...
,13,DAMAGE_TYPE_SONIC
,14,DAMAGE_TYPE_EMOTIONAL
,0,DEREZ_DIE
,1,DEREZ_MAKE_TEMP
,2,FILTER_FLAGS
,1,FILTER_INCLUDE
,0x0001,FILTER_FLAG_HUDS
...
,4,GAME_CONTROL_AXIS_TRIGGERLEFT
,5,GAME_CONTROL_AXIS_TRIGGERRIGHT
,0x00000001,GAME_CONTROL_BUTTON_A
,0x00000002,GAME_CONTROL_BUTTON_B
,0x00000004,GAME_CONTROL_BUTTON_X
,0x00000008,GAME_CONTROL_BUTTON_Y
,0x00000010,GAME_CONTROL_BUTTON_BACK
,0x00000020,GAME_CONTROL_BUTTON_GUIDE
,0x00000040,GAME_CONTROL_BUTTON_START
,0x00000080,GAME_CONTROL_BUTTON_LEFTSTICK
,0x00000100,GAME_CONTROL_BUTTON_RIGHTSTICK
,0x00000200,GAME_CONTROL_BUTTON_LEFTSHOULDER
,0x00000400,GAME_CONTROL_BUTTON_RIGHTSHOULDER
,0x00000800,GAME_CONTROL_BUTTON_DPAD_UP
,0x00001000,GAME_CONTROL_BUTTON_DPAD_DOWN
,0x00002000,GAME_CONTROL_BUTTON_DPAD_LEFT
,0x00004000,GAME_CONTROL_BUTTON_DPAD_RIGHT
,0x00008000,GAME_CONTROL_BUTTON_MISC1
]);
c([
0x00010000,GAME_CONTROL_BUTTON_PADDLE1
,0x00020000,GAME_CONTROL_BUTTON_PADDLE2
,0x00040000,GAME_CONTROL_BUTTON_PADDLE3
,0x00080000,GAME_CONTROL_BUTTON_PADDLE4
,0x00100000,GAME_CONTROL_BUTTON_TOUCHPAD
,50,OBJECT_HEALTH
,51,OBJECT_DAMAGE
,52,OBJECT_DAMAGE_TYPE
,51,PRIM_DAMAGE
,52,PRIM_HEALTH
,12,REZ_DAMAGE_TYPE
,13,REZ_PARAM_STRING
,32,SIT_FLAG_NO_DAMAGE
,0,TRANSFER_DEST
,1,TRANSFER_FLAGS
,0x0001,TRANSFER_FLAG_RESERVED
,0x0002,TRANSFER_FLAG_TAKE
,0x0004,TRANSFER_FLAG_COPY
,0,TRANSFER_OK
,-1,TRANSFER_BAD_OPTS
]);
c([
-2,TRANSFER_NO_TARGET
,-3,TRANSFER_THROTTLE
,-4,TRANSFER_NO_ITEMS
,-5,TRANSFER_BAD_ROOT
,-6,TRANSFER_NO_PERMS
,-7,TRANSFER_NO_ATTACHMENT
,0x0400,VEHICLE_FLAG_BLOCK_INTERFERENCE
,"00000000-0000-0000-0000-000000000000",NULL_KEY
,"\n\n\n",EOF
,"\n\n",NAK
...
,"45e0fcfa-2268-4490-a51c-3e51bdfe80d1",COMBAT_LOG_ID
