...
allConstants = [
    ...
    Constant "JSON_ARRAY" (SVal "\xef\xb7\x92"),
    Constant "JSON_DELETE" (SVal "\xef\xb7\x98"),
    Constant "JSON_FALSE" (SVal "\xef\xb7\x97"),
    Constant "JSON_INVALID" (SVal "\xef\xb7\x90"),
    Constant "JSON_NULL" (SVal "\xef\xb7\x95"),
    Constant "JSON_NUMBER" (SVal "\xef\xb7\x93"),
    Constant "JSON_OBJECT" (SVal "\xef\xb7\x91"),
    Constant "JSON_STRING" (SVal "\xef\xb7\x94"),
    Constant "JSON_TRUE" (SVal "\xef\xb7\x96"),
