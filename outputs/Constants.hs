...
allConstants = [
    ...
    Constant "DEG_TO_RAD" (FVal 0.017453292),
    ...
    Constant "KFM_CMD_SET_MODE" (IVal 3),
    ...
    Constant "RAD_TO_DEG" (FVal 57.295779),
    ...
    Constant "STRING_TRIM" (IVal 3),
    Constant "STRING_TRIM_HEAD" (IVal 1),
    Constant "STRING_TRIM_TAIL" (IVal 2),
