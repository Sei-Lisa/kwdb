...
-- Generated by LSL2 Derived Files Generator. Database version: 0.0.20250202000; output module version: 0.0.20240415000
...
allConstants = [
    ...
    Constant "AGENT_FLOATING_VIA_SCRIPTED_ATTACHMENT" (IVal 32768),
    ...
    Constant "ATTACH_ANY_HUD" (IVal (-1)),
    ...
    Constant "COMBAT_CHANNEL" (IVal 2147483646),
    Constant "COMBAT_LOG_ID" (SVal "45e0fcfa-2268-4490-a51c-3e51bdfe80d1"),
    ...
    Constant "DAMAGEABLE" (IVal 0x20),
    Constant "DAMAGE_TYPE_ACID" (IVal 1),
    Constant "DAMAGE_TYPE_BLUDGEONING" (IVal 2),
    Constant "DAMAGE_TYPE_COLD" (IVal 3),
    Constant "DAMAGE_TYPE_ELECTRIC" (IVal 4),
    Constant "DAMAGE_TYPE_EMOTIONAL" (IVal 14),
    Constant "DAMAGE_TYPE_FIRE" (IVal 5),
    Constant "DAMAGE_TYPE_FORCE" (IVal 6),
    Constant "DAMAGE_TYPE_GENERIC" (IVal 0),
    Constant "DAMAGE_TYPE_IMPACT" (IVal (-1)),
    Constant "DAMAGE_TYPE_NECROTIC" (IVal 7),
    Constant "DAMAGE_TYPE_PIERCING" (IVal 8),
    Constant "DAMAGE_TYPE_POISON" (IVal 9),
    Constant "DAMAGE_TYPE_PSYCHIC" (IVal 10),
    Constant "DAMAGE_TYPE_RADIANT" (IVal 11),
    Constant "DAMAGE_TYPE_SLASHING" (IVal 12),
    Constant "DAMAGE_TYPE_SONIC" (IVal 13),
    ...
    Constant "DEREZ_DIE" (IVal 0),
    Constant "DEREZ_MAKE_TEMP" (IVal 1),
    ...
    Constant "FILTER_FLAGS" (IVal 2),
    Constant "FILTER_FLAG_HUDS" (IVal 0x0001),
    Constant "FILTER_INCLUDE" (IVal 1),
    Constant "FORCE_DIRECT_PATH" (IVal 1),
    Constant "FRICTION" (IVal 0x2),
    Constant "GAME_CONTROL_AXIS_LEFTX" (IVal 0),
    Constant "GAME_CONTROL_AXIS_LEFTY" (IVal 1),
    Constant "GAME_CONTROL_AXIS_RIGHTX" (IVal 2),
    Constant "GAME_CONTROL_AXIS_RIGHTY" (IVal 3),
    Constant "GAME_CONTROL_AXIS_TRIGGERLEFT" (IVal 4),
    Constant "GAME_CONTROL_AXIS_TRIGGERRIGHT" (IVal 5),
    Constant "GAME_CONTROL_BUTTON_A" (IVal 0x00000001),
    Constant "GAME_CONTROL_BUTTON_B" (IVal 0x00000002),
    Constant "GAME_CONTROL_BUTTON_BACK" (IVal 0x00000010),
    Constant "GAME_CONTROL_BUTTON_DPAD_DOWN" (IVal 0x00001000),
    Constant "GAME_CONTROL_BUTTON_DPAD_LEFT" (IVal 0x00002000),
    Constant "GAME_CONTROL_BUTTON_DPAD_RIGHT" (IVal 0x00004000),
    Constant "GAME_CONTROL_BUTTON_DPAD_UP" (IVal 0x00000800),
    Constant "GAME_CONTROL_BUTTON_GUIDE" (IVal 0x00000020),
    Constant "GAME_CONTROL_BUTTON_LEFTSHOULDER" (IVal 0x00000200),
    Constant "GAME_CONTROL_BUTTON_LEFTSTICK" (IVal 0x00000080),
    Constant "GAME_CONTROL_BUTTON_MISC1" (IVal 0x00008000),
    Constant "GAME_CONTROL_BUTTON_PADDLE1" (IVal 0x00010000),
    Constant "GAME_CONTROL_BUTTON_PADDLE2" (IVal 0x00020000),
    Constant "GAME_CONTROL_BUTTON_PADDLE3" (IVal 0x00040000),
    Constant "GAME_CONTROL_BUTTON_PADDLE4" (IVal 0x00080000),
    Constant "GAME_CONTROL_BUTTON_RIGHTSHOULDER" (IVal 0x00000400),
    Constant "GAME_CONTROL_BUTTON_RIGHTSTICK" (IVal 0x00000100),
    Constant "GAME_CONTROL_BUTTON_START" (IVal 0x00000040),
    Constant "GAME_CONTROL_BUTTON_TOUCHPAD" (IVal 0x00100000),
    Constant "GAME_CONTROL_BUTTON_X" (IVal 0x00000004),
    Constant "GAME_CONTROL_BUTTON_Y" (IVal 0x00000008),
    ...
    Constant "OBJECT_DAMAGE" (IVal 51),
    Constant "OBJECT_DAMAGE_TYPE" (IVal 52),
    Constant "OBJECT_DESC" (IVal 2),
    Constant "OBJECT_GROUP" (IVal 7),
    Constant "OBJECT_GROUP_TAG" (IVal 33),
    Constant "OBJECT_HEALTH" (IVal 50),
    ...
    Constant "PRIM_REFLECTION_PROBE_MIRROR" (IVal 4),
    ...
    Constant "PRIM_SIT_FLAGS" (IVal 50),
    ...
    Constant "REZ_ACCEL" (IVal 5),
    Constant "REZ_DAMAGE" (IVal 8),
    Constant "REZ_DAMAGE_TYPE" (IVal 12),
    Constant "REZ_FLAGS" (IVal 1),
    Constant "REZ_FLAG_BLOCK_GRAB_OBJECT" (IVal 128),
    Constant "REZ_FLAG_DIE_ON_COLLIDE" (IVal 8),
    Constant "REZ_FLAG_DIE_ON_NOENTRY" (IVal 16),
    Constant "REZ_FLAG_NO_COLLIDE_FAMILY" (IVal 64),
    Constant "REZ_FLAG_NO_COLLIDE_OWNER" (IVal 32),
    Constant "REZ_FLAG_PHANTOM" (IVal 4),
    Constant "REZ_FLAG_PHYSICAL" (IVal 2),
    Constant "REZ_FLAG_TEMP" (IVal 1),
    ...
    Constant "REZ_SOUND_COLLIDE" (IVal 10),
    Constant "REZ_VEL" (IVal 4),
    ...
    Constant "SIT_FLAG_ALLOW_UNSIT" (IVal 2),
    Constant "SIT_FLAG_NO_COLLIDE" (IVal 16),
    Constant "SIT_FLAG_NO_DAMAGE" (IVal 32),
    Constant "SIT_FLAG_SCRIPTED_ONLY" (IVal 4),
    Constant "SIT_FLAG_SIT_TARGET" (IVal 1),
    ...
    Constant "TRANSFER_BAD_OPTS" (IVal (-1)),
    Constant "TRANSFER_BAD_ROOT" (IVal (-5)),
    Constant "TRANSFER_DEST" (IVal 0),
    Constant "TRANSFER_FLAGS" (IVal 1),
    Constant "TRANSFER_FLAG_COPY" (IVal 0x0004),
    Constant "TRANSFER_FLAG_RESERVED" (IVal 0x0001),
    Constant "TRANSFER_FLAG_TAKE" (IVal 0x0002),
    Constant "TRANSFER_NO_ATTACHMENT" (IVal (-7)),
    Constant "TRANSFER_NO_ITEMS" (IVal (-4)),
    Constant "TRANSFER_NO_PERMS" (IVal (-6)),
    Constant "TRANSFER_NO_TARGET" (IVal (-2)),
    Constant "TRANSFER_OK" (IVal 0),
    Constant "TRANSFER_THROTTLE" (IVal (-3)),
    ...
    Constant "VEHICLE_FLAG_BLOCK_INTERFERENCE" (IVal 0x0400),
