...
-- Generated by LSL2 Derived Files Generator. Database version: 0.0.20240528000; output module version: 0.0.20240415000
...
allConstants = [
    ...
    Constant "COMBAT_CHANNEL" (IVal 0x7FFFFFFE),
    Constant "COMBAT_LOG_ID" (KVal $ LSLKey "45e0fcfa-2268-4490-a51c-3e51bdfe80d1"),
    ...
    Constant "DAMAGE_TYPE_EMOTIONAL" (IVal 13),
    ...
    Constant "SIT_FLAG_NO_DAMAGE" (IVal 16),
