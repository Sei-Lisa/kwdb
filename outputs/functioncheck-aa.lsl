...
default
{
    state_entry()
    {
        ...
        outp += "\nGenerated by LSL2 Derived Files Generator. Database version: 0.0.20170109000; output module version: 0.0.20160606000";
...
s = s + osSetDynamicTextureURLBlendFace(s,s,s,s,b,i,i,i,i);
s = s + osSetDynamicTextureData(s,s,s,s,i);
s = s + osSetDynamicTextureDataBlend(s,s,s,s,i,i);
s = s + osSetDynamicTextureDataBlendFace(s,s,s,s,b,i,i,i,i);
