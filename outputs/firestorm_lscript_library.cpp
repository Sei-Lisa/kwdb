...
// Generated by LSL2 Derived Files Generator. Database version: 0.0.20161017000; output module version: 0.0.20140615000
	...
	addFunction(10.f, 0.f, dummy_func, "llGetTimeOfDay", "f", NULL);
	addFunction(10.f, 0.f, dummy_func, "llGetWallclock", "f", NULL);
	...
	addFunction(10.f, 0.f, dummy_func, "llStopSound", NULL, NULL);
	...
	addFunction(10.f, 0.f, dummy_func, "llIntegerToBase64", "s", "i");
	addFunction(10.f, 0.f, dummy_func, "llBase64ToInteger", "i", "s");
	addFunction(10.f, 0.f, dummy_func, "llGetGMTclock", "f", NULL);
	addFunction(10.f, 10.f, dummy_func, "llGetSimulatorHostname", "s", NULL);
	...
	addFunction(10.f, 0.f, dummy_func, "llGetObjectPermMask", "i", "i");
	addFunction(10.f, 0.f, dummy_func, "llSetObjectPermMask", NULL, "ii", TRUE);
	addFunction(10.f, 0.f, dummy_func, "llGetInventoryPermMask", "i", "si");
	addFunction(10.f, 0.f, dummy_func, "llSetInventoryPermMask", NULL, "sii", TRUE);
	addFunction(10.f, 0.f, dummy_func, "llGetInventoryCreator", "k", "s");
	...
	addFunction(10.f, 0.1f, dummy_func, "llLoadURL", NULL, "kss");
	...
	addFunction(10.f, 0.f, dummy_func, "llGetCameraPos", "v", NULL);
	addFunction(10.f, 0.f, dummy_func, "llGetCameraRot", "q", NULL);
	addFunction(10.f, 20.f, dummy_func, "llSetPrimURL", NULL, "s");
	addFunction(10.f, 20.f, dummy_func, "llRefreshPrimURL", NULL, NULL);
	...
	addFunction(10.f, 2.f, dummy_func, "llGetParcelPrimOwners", "l", "v");
	...
	addFunction(10.f, 1.f, dummy_func, "llSetPrimMediaParams", "i", "il");
	addFunction(10.f, 1.f, dummy_func, "llGetPrimMediaParams", "l", "il");
	addFunction(10.f, 1.f, dummy_func, "llClearPrimMedia", "i", "i");
	...
	addFunction(0.f, 0.f, dummy_func, "llWanderWithin", NULL, "vvl");
	...
	addFunction(10.f, 0.f, dummy_func, "llSetAnimationOverride", NULL, "ss");
	addFunction(10.f, 0.f, dummy_func, "llGetAnimationOverride", "s", "s");
	addFunction(10.f, 0.f, dummy_func, "llResetAnimationOverride", NULL, "s");
	addFunction(10.f, 0.f, dummy_func, "llJson2List", "l", "s");
	addFunction(10.f, 0.f, dummy_func, "llList2Json", "s", "sl");
	addFunction(10.f, 0.f, dummy_func, "llJsonGetValue", "s", "sl");
	addFunction(10.f, 0.f, dummy_func, "llJsonSetValue", "s", "sls");
	addFunction(10.f, 0.f, dummy_func, "llJsonValueType", "s", "sl");
	addFunction(10.f, 0.f, dummy_func, "llReturnObjectsByID", "i", "l");
	addFunction(10.f, 0.f, dummy_func, "llReturnObjectsByOwner", "i", "ki");
	addFunction(10.f, 0.f, dummy_func, "llXorBase64", "s", "ss");
	...
	addFunction(10.f, 0.f, dummy_func, "llAgentInExperience", "i", "k");
	addFunction(10.f, 0.f, dummy_func, "llGetExperienceDetails", "l", "k");
	addFunction(10.f, 0.f, dummy_func, "llRequestExperiencePermissions", NULL, "ks");
	addFunction(10.f, 0.f, dummy_func, "llReadKeyValue", "k", "s");
	addFunction(10.f, 0.f, dummy_func, "llCreateKeyValue", "k", "ss");
	addFunction(10.f, 0.f, dummy_func, "llUpdateKeyValue", "k", "ssis");
	addFunction(10.f, 0.f, dummy_func, "llDeleteKeyValue", "k", "s");
	addFunction(10.f, 0.f, dummy_func, "llDataSizeKeyValue", "k", NULL);
	addFunction(10.f, 0.f, dummy_func, "llKeysKeyValue", "k", "ii");
	addFunction(10.f, 0.f, dummy_func, "llKeyCountKeyValue", "k", NULL);
	addFunction(10.f, 0.f, dummy_func, "llGetExperienceErrorMessage", "s", "i");
	addFunction(10.f, 0.f, dummy_func, "llGetExperienceList", "l", "k");
	addFunction(10.f, 0.f, dummy_func, "llClearExperiencePermissions", NULL, "k");
	addFunction(10.f, 0.f, dummy_func, "llGetAttachedList", "l", "k");
	addFunction(10.f, 0.f, dummy_func, "llSitOnLink", "i", "ki");
...
// Generated by LSL2 Derived Files Generator. Database version: 0.0.20161017000; output module version: 0.0.20140615000
	...
	addFunction(10.f, 0.f, dummy_func, "lsClearWindlightScene", NULL, NULL);
	addFunction(10.f, 0.f, dummy_func, "osSetDynamicTextureURL", "s", "ssssi");
	addFunction(10.f, 0.f, dummy_func, "osSetDynamicTextureURLBlend", "s", "ssssii");
	addFunction(10.f, 0.f, dummy_func, "osSetDynamicTextureURLBlendFace", "s", "ssssiiiii");
	addFunction(10.f, 0.f, dummy_func, "osSetDynamicTextureData", "s", "ssssi");
	addFunction(10.f, 0.f, dummy_func, "osSetDynamicTextureDataBlend", "s", "ssssii");
	addFunction(10.f, 0.f, dummy_func, "osSetDynamicTextureDataBlendFace", "s", "ssssiiiii");
	addFunction(10.f, 0.f, dummy_func, "osGetTerrainHeight", "f", "ii");
	addFunction(10.f, 0.f, dummy_func, "osTerrainGetHeight", "f", "ii");
	addFunction(10.f, 0.f, dummy_func, "osSetTerrainHeight", "i", "iif");
	addFunction(10.f, 0.f, dummy_func, "osTerrainSetHeight", "i", "iif");
	...
	addFunction(10.f, 0.f, dummy_func, "osConsoleCommand", "i", "s");
	...
	addFunction(10.f, 0.f, dummy_func, "osGetAgentIP", "s", "s");
	addFunction(10.f, 0.f, dummy_func, "osGetAgents", "l", NULL);
	addFunction(10.f, 0.f, dummy_func, "osTeleportAgent", NULL, "ssvv");
	addFunction(10.f, 0.f, dummy_func, "osTeleportOwner", NULL, "svv");
	addFunction(10.f, 0.f, dummy_func, "osAvatarPlayAnimation", NULL, "ss");
	addFunction(10.f, 0.f, dummy_func, "osAvatarStopAnimation", NULL, "ss");
	...
	addFunction(10.f, 0.f, dummy_func, "osMovePen", "s", "sii");
	addFunction(10.f, 0.f, dummy_func, "osDrawLine", "s", "siiii");
	addFunction(10.f, 0.f, dummy_func, "osDrawText", "s", "ss");
	addFunction(10.f, 0.f, dummy_func, "osDrawEllipse", "s", "sii");
	addFunction(10.f, 0.f, dummy_func, "osDrawRectangle", "s", "sii");
	addFunction(10.f, 0.f, dummy_func, "osDrawFilledRectangle", "s", "sii");
	addFunction(10.f, 0.f, dummy_func, "osDrawPolygon", "s", "sll");
	addFunction(10.f, 0.f, dummy_func, "osDrawFilledPolygon", "s", "sll");
	addFunction(10.f, 0.f, dummy_func, "osSetFontName", "s", "ss");
	addFunction(10.f, 0.f, dummy_func, "osSetFontSize", "s", "si");
	addFunction(10.f, 0.f, dummy_func, "osSetPenSize", "s", "si");
	addFunction(10.f, 0.f, dummy_func, "osSetPenColor", "s", "ss");
	addFunction(10.f, 0.f, dummy_func, "osSetPenColour", "s", "ss");
	addFunction(10.f, 0.f, dummy_func, "osSetPenCap", "s", "sss");
	addFunction(10.f, 0.f, dummy_func, "osDrawImage", "s", "siis");
	...
	addFunction(10.f, 0.f, dummy_func, "osSunGetParam", "f", "s");
	addFunction(10.f, 0.f, dummy_func, "osSetSunParam", NULL, "sf");
	addFunction(10.f, 0.f, dummy_func, "osSunSetParam", NULL, "sf");
	...
	addFunction(10.f, 0.f, dummy_func, "osParcelSetDetails", NULL, "vl");
	...
	addFunction(10.f, 0.f, dummy_func, "osAvatarName2Key", "s", "ss");
	addFunction(10.f, 0.f, dummy_func, "osKey2Name", "s", "s");
	...
	addFunction(10.f, 0.f, dummy_func, "osGetGridGatekeeperURI", "s", NULL);
	...
	addFunction(10.f, 0.f, dummy_func, "osReplaceString", "s", "sssii");
	...
	addFunction(10.f, 0.f, dummy_func, "osNpcCreate", "k", "ssvs");
	...
	addFunction(10.f, 0.f, dummy_func, "osNpcGetRot", "q", "k");
	addFunction(10.f, 0.f, dummy_func, "osNpcSetRot", NULL, "kq");
	addFunction(10.f, 0.f, dummy_func, "osNpcStopMoveToTarget", NULL, "k");
	addFunction(10.f, 0.f, dummy_func, "osNpcSay", NULL, "ks");
	addFunction(10.f, 0.f, dummy_func, "osNpcShout", NULL, "kis");
	...
	addFunction(10.f, 0.f, dummy_func, "osNpcWhisper", NULL, "kis");
	...
	addFunction(10.f, 0.f, dummy_func, "osGetHealth", "f", "s");
	addFunction(10.f, 0.f, dummy_func, "osCauseHealing", NULL, "sf");
	addFunction(10.f, 0.f, dummy_func, "osCauseDamage", NULL, "sf");
	addFunction(10.f, 0.f, dummy_func, "osGetPrimitiveParams", "l", "kl");
	addFunction(10.f, 0.f, dummy_func, "osSetPrimitiveParams", NULL, "kl");
	addFunction(10.f, 0.f, dummy_func, "osSetProjectionParams", NULL, "ikfff");
	...
	addFunction(10.f, 0.f, dummy_func, "osInviteToGroup", "i", "k");
	addFunction(10.f, 0.f, dummy_func, "osEjectFromGroup", "i", "k");
	...
	addFunction(10.f, 0.f, dummy_func, "osDropAttachmentAt", NULL, "vq");
	addFunction(10.f, 0.f, dummy_func, "osForceDropAttachmentAt", NULL, "vq");
	addFunction(10.f, 0.f, dummy_func, "osListenRegex", "i", "isssi");
	addFunction(10.f, 0.f, dummy_func, "osRegexIsMatch", "i", "ss");

// Generated by LSL2 Derived Files Generator. Database version: 0.0.20161017000; output module version: 0.0.20140615000
	addFunction(10.f, 0.f, dummy_func, "llLinkLookAt", NULL, "ivff");
	addFunction(10.f, 0.f, dummy_func, "llLinkRotLookAt", NULL, "iqff");
	addFunction(10.f, 0.f, dummy_func, "llAvatarOnLinkSitTarget", "k", NULL);
	addFunction(0.f, 0.f, dummy_func, "llWanderWithin", NULL, "vfl");
	addFunction(10.f, 0.f, dummy_func, "osGetThreatLevel", "s", "s");
	...
	addFunction(10.f, 0.f, dummy_func, "osAddAgentToGroup", "i", "kss");
	addFunction(10.f, 0.f, dummy_func, "osRezObject", NULL, "svvqiiiii");
	addFunction(10.f, 0.f, dummy_func, "osCauseDamage", NULL, "sfsvv");
	...
	addFunction(10.f, 0.f, dummy_func, "aaDeserializeXMLValues", "l", "k");
	addFunction(10.f, 0.f, dummy_func, "aaDeserializeXMLKeys", "l", "k");
	addFunction(10.f, 0.f, dummy_func, "aaSetConeOfSilence", NULL, "f");
	addFunction(10.f, 0.f, dummy_func, "aaSerializeXML", "k", "ll");
	...
	addFunction(10.f, 0.f, dummy_func, "aaSetFlyDisabled", NULL, "si");
	addFunction(10.f, 0.f, dummy_func, "aaAvatarFullName2Key", "k", "s");
	addFunction(10.f, 0.f, dummy_func, "aaRaiseError", NULL, "s");
	addFunction(10.f, 0.f, dummy_func, "aaGetText", "k", NULL);
	addFunction(10.f, 0.f, dummy_func, "aaGetTextColor", "q", NULL);
	...
	addFunction(10.f, 0.f, dummy_func, "aaWindlightGetScene", "l", "l");
	addFunction(10.f, 0.f, dummy_func, "aaWindlightSetScene", "i", "l");
	addFunction(10.f, 0.f, dummy_func, "botGetWaitingTime", "v", "i");
	addFunction(10.f, 0.f, dummy_func, "botSetMap", NULL, "slli");
